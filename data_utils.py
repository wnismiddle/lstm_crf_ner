...
jieba.load_userdict('data/dict/sum_dict.txt')
# jieba.initialize()
...
class BatchManager(object):
    ...
    def sort_and_pad(self, data, batch_size):
        ...
        for i in range(num_batch):
            ...
            # print(sorted_data[0.0: 20.0])
            # print('----------------------')
            # print(self.pad_data(sorted_data[int(i*batch_size) : int((i+1)*batch_size)]))
    ...
    def pad_data(data):
        ...
        max_length = max([len(sentence[0]) for sentence in data])
        for line in data:
            string, char, seg, pos, target = line
            padding = [0] * (max_length - len(string))
            strings.append(string + padding)
            chars.append(char + padding)
            segs.append(seg + padding)
            ...
            targets.append(target + padding)
        return [strings, chars, segs, poss, targets]
